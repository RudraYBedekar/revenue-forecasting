...
### 1. **Key Performance Indicators (KPIs)** ![KPI Dashboard](kpi_dashboard.png)
...
### 2. **Raw Data & Granular Tracking** ![Raw Data Tracking](raw_data_tracking.png)
...
### 3. **AI Forecasting (SARIMA vs ARIMA)** ![AI Forecasting](ai_forecasting.png)
...
### 4. **Regional & Department Rankings** ![Regional Rankings](regional_rankings.png)
